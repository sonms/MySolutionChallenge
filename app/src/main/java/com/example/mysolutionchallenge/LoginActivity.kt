...
import com.example.mysolutionchallenge.databinding.ActivityLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (auth.currentUser != null) {
            val intent = Intent(this, MainActivity::class.java).apply {
                putExtra("email",  mBinding.userEmail.text.toString())
                putExtra("password", mBinding.userPassword.text.toString())
            }
        ...
        loginBtn.setOnClickListener {
            if (mBinding.userEmail.text.toString().isEmpty()) {
                Toast.makeText(this,"Email을 입력해주세요", Toast.LENGTH_SHORT).show()
            } else {
                createAccount(mBinding.userEmail.text.toString(), mBinding.userPassword.text.toString())
